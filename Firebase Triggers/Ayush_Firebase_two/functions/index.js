...
exports.updateRegistration = functions.firestore
    .document('placement_events/Registrations')
      ...
      // perform desired operations ...
		...
		if(stat)
		{
			company= newValue.Company;
			 input_content="Registrations for "+company+" are now open.";
		}
		else
		{
			company= previousValue.Company;
			input_content="Registrations for "+company+" are closed.";
		}
